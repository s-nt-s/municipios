...
class jFile:
    ...
    def open(self):
        if self.main == "7z" and len(self.files)>1 and (self.tmp is None or not os.path.isfile(self.tmp)):
            with tempfile.NamedTemporaryFile(suffix="."+self.type, delete=False) as tmp:
